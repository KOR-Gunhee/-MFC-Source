...
char pszMenuJuiceInfo[2][100] = { "사과로 만든 쥬스", "오렌지로 만든 쥬스" };
char pszMenuCoffeeInfo[3][100] = { "향이 좋은 따뜻한 Coffee", "시원한 아이스 커피", "달콤한 커피" };
char pszMenuDessertInfo[3][100] = { "신선한 바닐라 아이스크림", "초콜릿이 듬북 들어간 초코 케이크", "촉촉하고 부드러운 치즈 케이크" };
