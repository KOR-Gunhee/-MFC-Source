...
CSpinCtrlDlg::CSpinCtrlDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_SPINCTRL_DIALOG, pParent)
{
...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_SPIN_NUM, m_cSpin);
}

BEGIN_MESSAGE_MAP(CSpinCtrlDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
